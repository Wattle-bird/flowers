function drawSimpleFlower(flower) {
  ...
  return `<div class=wiggle style="width: 30px; height: 30px; animation-delay: ${delay}s; position: relative; top: ${flower.y}px; left: ${flower.x}px; font-weight: 900; display: inline-block;">
